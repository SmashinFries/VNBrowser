...
import { VNBrowserSVG, VNBrowserTextSVG } from '@/components/icons';
...
const IntroSection = () => {
	...
	return (
		<View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
			<VNBrowserSVG height={100} width={'100%'} />
			<VNBrowserTextSVG height={80} width={'80%'} />
			<Text>There's a few things we need to setup first!</Text>
		</View>
	);
};
